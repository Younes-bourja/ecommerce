								...
								<div class="row row-sm ">
									<div class=" col-xl-5 col-lg-12 col-md-12">
										<div class="preview-pic tab-content">
										  <div class="tab-pane active" id="pic-1"><img src="{{URL::asset('assets/img/images')}}/{{$st->photo}}" alt="image"/></div>
										  <div class="tab-pane" id="pic-2"><img src="{{URL::asset('assets/img/images')}}/{{$st->image1}}" alt="image"/></div>
										  <div class="tab-pane" id="pic-3"><img src="{{URL::asset('assets/img/images')}}/{{$st->image2}}" alt="image"/></div>
										  <div class="tab-pane" id="pic-4"><img src="{{URL::asset('assets/img/images')}}/{{$st->image3}}" alt="image"/></div>
