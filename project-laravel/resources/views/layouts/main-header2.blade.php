...
<div class="main-header sticky side-header nav nav-item">
			...
			<div class=" d-sm-none d-md-block d-lg-block "  style="position: absolute;right: 0;">
			<a href="{{ url('/' . $page='?famille=') }}"><img src="{{URL::asset('assets/img/brand/logo.png')}}" class="logo-1 h-25 w-25" alt="logo"></a>
			</div>
...
<input type="text" name="page" value="<?php if(isset($_GET['page'])){ echo $_GET['page']; }?>" hidden>
                    ...
                    @endforeach
						...
						<div class="responsive-logo">
							<a href="{{ url('/' . $page='?famille=') }}"><img src="{{URL::asset('assets/img/brand/logo.png')}}" class="logo-1" alt="logo"></a>
							<a href="{{ url('/' . $page='?famille=') }}"><img src="{{URL::asset('assets/img/brand/logo.png')}}" class="dark-logo-1" alt="logo"></a>
							<a href="{{ url('/' . $page='?famille=') }}"><img src="{{URL::asset('assets/img/brand/logo.png')}}" class="logo-2" alt="logo"></a>
							<a href="{{ url('/' . $page='?famille=') }}"><img src="{{URL::asset('assets/img/brand/logo.png')}}" class="dark-logo-2" alt="logo"></a>
						</div>
					...
					<div class="d-sm-block d-md-block d-lg-none w-100"  >
