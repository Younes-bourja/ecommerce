				...
				<div class="panel-body tabs-menu-body latest-tasks p-0 border-0">
					<div class="tab-content">
                        ...
                        class="modal-effect btn btn-sm border-0 btn-outline-success"
								...
								<a class="wrapper w-100 mr-3" href="#" >
									...
									<div class="d-flex justify-content-between align-items-center">
										<div class="d-flex align-items-center">
										 <small class="text-muted ml-auto"> الثمن:{{$panier->prix}}</small>
											<small class="text-muted ml-auto mr-2">الكمية :{{$panier->quantite}}</small>
                            ...
                            <small class="text-muted ml-auto " >{{$panier->prix*$panier->quantite}}
