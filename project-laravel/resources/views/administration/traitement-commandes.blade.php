...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">صفحة الطلبيات في طور المعالجة </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0"> </span>
						</div>
					</div>
...
<div class="modal fade "  id="commande<?php echo $t;?>">
		 ...
		 @if(Session::has('coin'))  {{Session::get('coin')}}@endif </h4>
											...
											<td>{{$st->prixtotal}}</td>
                                            <td  >
											<span class="badge bg-info-transparent text-primary mr-auto ">
		...
		<div class="modal  effect-scale show" id="accept">
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content modal-content-demo ">
					...
					<form action="traitement-commandes/update" method="post">
						{{method_field('PUT')}}						
						{{csrf_field()}}
