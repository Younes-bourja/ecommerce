...
<div class="container ">
    <div class="row justify-content-center mt-5">
        <div class="col-md-8 mt-5">
            <div class="card mt-5">
                <h4 class="card-header text-center">{{ __('التسجيل') }}</h4>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="password" class="col-md-4 col-form-label text-md-end">{{ __('كلمةالمرور') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end">{{ __('تأكيد كلمةالمرور') }}</label>
